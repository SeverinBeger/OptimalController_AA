#ifndef __RocketSim_sfun_h__
#define __RocketSim_sfun_h__
...
extern mxArray* load_RocketSim_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_RocketSim_optimization_info(void);
